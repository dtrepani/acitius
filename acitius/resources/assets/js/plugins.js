...
$(() => {
   ...
   */
  $('body').on('submit', 'form[name=delete_item]', (e) => {
    e.preventDefault();
    const form = this;
    ...
    const title = (link.attr('data-trans-title')) ? link.attr('data-trans-title') : 'Warning';
    const text = (link.attr('data-trans-text'))
      ? link.attr('data-trans-text')
